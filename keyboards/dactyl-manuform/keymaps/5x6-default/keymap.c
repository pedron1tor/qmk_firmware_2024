...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_QWERTY] = KEYMAP_5x6(
        ...
        KC_LCTL,         KC_A,    KC_S,    KC_D,    KC_F,    KC_G,         KC_ENT,  KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,
      KC_LSFT,         KC_Z,    KC_X,    KC_C,    KC_V,                             KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,
        KC_LALT,         KC_GRV,  KC_LBRC, KC_RBRC, KC_BSLS,                        KC_SPC,  KC_RSFT, KC_QUOT, KC_EQL,  KC_LEFT,
        LT(_FN, KC_DEL), KC_SPC,  KC_LGUI, KC_ENT,                                  KC_UP,   KC_RGUI, KC_PGUP, KC_PGDOWN
    ),
